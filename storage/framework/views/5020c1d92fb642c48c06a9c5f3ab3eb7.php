...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="text-end">
            <i class='bx bx-calendar me-1'></i><?php echo e(now()->translatedFormat('l, d F Y')); ?>
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius: 16px;">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="<?php echo e(route('order.index')); ?>" class="btn btn-sm px-3"
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius: 16px;">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="<?php echo e(route('projectmp.index')); ?>" class="btn btn-sm px-3"
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" style="font-size: 13px;">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $orderTerbesarOffline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="align-middle">
                                            <span
                                                class="badge bg-light text-dark"><?php echo e(date('d/m', strtotime($order->created_at))); ?></span>
                                        </td>
                                        <td class="align-middle">
                                            <a href="<?php echo e(route('order.detail', $order->id)); ?>"
                                                class="text-decoration-none text-dark fw-medium">
                                                <?php echo e(\Illuminate\Support\Str::limit($order->kontak->nama ?? '-', 18, '...')); ?>

                                            </a>
                                        </td>
                                        <td class="align-middle text-end">
                                            <span class="fw-bold"
                                                style="color: #00b894;"><?php echo e(number_format($order->total, 0, ',', '.')); ?></span>
                                        </td>
                                    </tr>
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius: 16px;">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="<?php echo e(route('order.omzet')); ?>" class="btn btn-sm px-3"
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $produkTerlaris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="align-middle">
                                            <span
                                                class="fw-medium"><?php echo e(\Illuminate\Support\Str::limit($produk['nama_produk'] ?? '-', 24, '...')); ?></span>
                                        </td>
                                        <td class="align-middle text-end">
                                            <span class="fw-bold"
                                                style="color: #f39c12;"><?php echo e(number_format($produk['omzet'] ?? 0, 0, ',', '.')); ?></span>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            ...
                            <small class="text-muted"><?php echo e(now()->translatedFormat('d F Y')); ?></small>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" style="font-size: 13px;">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $orderTerbesarHariIni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="align-middle">
                                            <span
                                                class="fw-medium"><?php echo e(\Illuminate\Support\Str::limit($order['nama_produk'] ?? '-', 24, '...')); ?></span>
                                        </td>
                                        <td class="align-middle text-end">
                                            <span class="fw-bold"
                                                style="color: #0984e3;"><?php echo e(number_format($order['omzet'] ?? 0, 0, ',', '.')); ?></span>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
...
<?php $__env->startPush('after-scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        <?php $__currentLoopData = $sortedOffline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            datesOffline.push('<?php echo e($formattedDatesOffline[array_search($date, $offlineDates)]); ?>');
            valuesOffline.push(<?php echo e($data->offline ?? 0); ?>);
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

        // Data untuk chart online
        var datesOnline = [];
        <?php $__currentLoopData = $mpList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            var values_mp_<?php echo e($mp); ?> = [];
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

        <?php $__currentLoopData = $sortedOnline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            datesOnline.push('<?php echo e($formattedDatesOnline[array_search($date, $onlineDates)]); ?>');
            <?php $__currentLoopData = $mpList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                values_mp_<?php echo e($mp); ?>.push(<?php echo e($data->$mp ?? 0); ?>);
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        var optionsOnline = {
            ...
            series: [
                <?php $__currentLoopData = $mpList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    {
                        name: '<?php echo e(ucfirst(str_replace('_', ' ', $mp))); ?>',
                        data: values_mp_<?php echo e($mp); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/souvenirbag/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>