            ...
            <form method="POST" action="{{ route('level.update',$level->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" type="text"
                        name="nama" id="nama" value="{{ old('nama',$level->nama) }}">
                    @if ($errors->has('nama'))
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control {{ $errors->has('gaji_pokok') ? 'is-invalid' : '' }}" type="number"
                        name="gaji_pokok" id="gaji_pokok" value="{{ old('gaji_pokok',$level->gaji_pokok) }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control {{ $errors->has('komunikasi') ? 'is-invalid' : '' }}" type="number"
                        name="komunikasi" id="komunikasi" value="{{ old('komunikasi',$level->komunikasi) }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control {{ $errors->has('transportasi') ? 'is-invalid' : '' }}" type="number"
                        name="transportasi" id="transportasi" value="{{ old('transportasi',$level->transportasi) }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control {{ $errors->has('kehadiran') ? 'is-invalid' : '' }}" type="number"
                        name="kehadiran" id="kehadiran" value="{{ old('kehadiran',$level->kehadiran) }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control {{ $errors->has('lama_kerja') ? 'is-invalid' : '' }}" type="number"
                        name="lama_kerja" id="lama_kerja" value="{{ old('lama_kerja',$level->lama_kerja) }}">
